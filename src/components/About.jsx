...
const About = () => {
	...
	<>
		...
		>
			...
			ever. We pondered sustainable and effective conclusions to make utility poles and trees more luminous 
		...
		>
			...
			This encouraged us to engineer a conclusion to ease these those fatality 
			rates instead of trying to stop accidents as a whole. According to the 
			Federal Highway Administration (FWHA), our conclusion could greatly help 
			prevent roughly  36%, or around 1/3, of RwD accidents. This is because 
			our conclusion applies to car accidents into trees (19%), poles (6%), 
			barriers (5%), and other fixed objects (6%), all roadside objects that 
			can conclusion can be added to. 
		</motion.p>
		<motion.p
		variants={fadeIn("", "", 0.1, 1)}
		className='mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]'
		>
			...
			that attaches to the side view mirrors of vehicles by welding. Side view mirrors were chosen as a attachment
