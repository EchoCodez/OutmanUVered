		...
		<>
			...
			<div className='w-full flex'>
				...
				>
					...
					that the regular flashlight made the tree appear most illuminated, 
					compared to the UV flashlight and no light. On the contrary, we found that a 
					majority of people believed that the UV flashlight made the tree most noticeable, helping 
